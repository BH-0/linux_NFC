...
#define MFRC522_CS(x)    gpio_set_value(CS_GPIO,x)
#define MFRC522_Rst(x)   gpio_set_value(RST_GPIO,x)
#define MFRC522_SCK(x)   gpio_set_value(SCK_GPIO,x)
#define MFRC522_MOSI(x)  gpio_set_value(MOSI_GPIO,x)
#define MFRC522_MISO()   gpio_get_value(MISO_GPIO)
#define MFRC522_IRQ()    gpio_get_value(IRQ_GPIO)
